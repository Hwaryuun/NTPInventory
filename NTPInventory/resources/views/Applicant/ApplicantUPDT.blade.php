                        ...
                        @method('PUT')
                            ...
                            <div class = "EXSepator">
                                    ...
                                    <div class="field">
                                        ...
                                        <input type="text" name="itemnumber" placeholder="Example: EMP-001" value="{{old('itemnumber') ?? $applicants->itemnumber}}" style="@error('itemnumber') border: 1px solid red; @enderror" >
